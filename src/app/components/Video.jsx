...
export default function Video() {
  return (
   <div className={`md:mt-32 mt-8 ${styles.video} flex flex-col place-content-center`}>
    ...
    <div className='flex flex-row items-center gap-2 pt-8'>
      <Link target='_blank' href='https://www.youtube.com/watch?v=bmd5NigtmRc' className='flex flex-row items-center gap-2 '>
